...
public class CraftyCuisine implements ModInitializer {
    ...
    public static final FoodComponent GLOW_BERRY_JAM_FOOD = new FoodComponent.Builder().hunger(2).saturationModifier(1.5F)
    ...
    public static final FoodComponent COOKED_BACON_FOOD = new FoodComponent.Builder().hunger(4).saturationModifier(0.8F).meat().build();
    public static final FoodComponent MONSTER_MANICOTTI_FOOD = new FoodComponent.Builder().hunger(8).saturationModifier(1.2F)
            ...
            .meat()
            .build();
    public static final FoodComponent COOKED_SPIDER_EYE_FOOD = new FoodComponent.Builder().hunger(3).saturationModifier(1.2F)
            .meat()
            .build();
    public static final FoodComponent SWEET_BERRY_CANDY_FOOD = new FoodComponent.Builder().hunger(10).saturationModifier(1.2F)
    ...
    public static final Item BACON = new Item(new FabricItemSettings().group(ItemGroup.FOOD).food(FoodComponents.CHICKEN));
